...
@Component({
  selector: "app-techstatenew",
  templateUrl: "./techstatenew.component.html",
  styleUrls: ["./techstatenew.component.css"],
})
export class TechstatenewComponent implements OnInit {
