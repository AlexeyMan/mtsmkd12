...
import { Energycost, Energytemp } from "../../../_models/tep";
import { SettingsService } from "../../../_services/settings.service";
import { GeneralSettings } from "../../../_models/common";
import { MatSnackBar } from "@angular/material/snack-bar";

@Component({
  selector: "app-tempcond",
  templateUrl: "./tempcond.component.html",
  styleUrls: ["./tempcond.component.scss"],
})
export class TempcondComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.getEnergyTemp(this.house_id).subscribe((res) => {
      const data = res;
