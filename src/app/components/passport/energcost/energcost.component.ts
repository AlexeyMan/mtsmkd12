...
import { Energycost } from "../../../_models/tep";
import { SettingsService } from "../../../_services/settings.service";
import { GeneralSettings } from "../../../_models/common";
import { MatSnackBar } from "@angular/material/snack-bar";

@Component({
  selector: "app-energcost",
  templateUrl: "./energcost.component.html",
  styleUrls: ["./energcost.component.scss"],
})
export class EnergcostComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.getEnergyCosts(this.house_id).subscribe((res) => {
      const data = res;
